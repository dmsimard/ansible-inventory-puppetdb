...
=====
    ...
    usage: puppetdb.py [-h] [--server HOST] [--ssl_verify] [--ssl_key SSL_KEY]
                       [--ssl_cert SSL_CERT] [--api_version API_VERSION]
                       [--port PORT] [--timeout TIMEOUT] (--list | --host SERVER)
    
    PuppetDB Inventory Module
    
    optional arguments:
      -h, --help            show this help message and exit
      --server HOST         PuppetDB server. Defaults to localhost.
      --ssl_verify          Verify SSL certificate. Defaults to False.
      --ssl_key SSL_KEY     Path to SSL client key. Defaults to None.
      --ssl_cert SSL_CERT   Path to SSL client cert. Defaults to None.
      --api_version API_VERSION
                            API Version for puppetdb. Defaults to 3
      --port PORT           PuppetDB port. Defaults to 8080.
      --timeout TIMEOUT     Max timeout in seconds. Defaults to 10.
      --list                List servers known by PuppetDB
      --host SERVER         List details about specified host

Host example
============

    ./puppetdb.py --server puppetmaster.domain.tld --host node.domain.tld
    {
      "node.domain.tld": {
        "_timestamp": "Fri Mar 13 00:05:47 -0400 2015", 
        ...
        "memoryfree": "122.46 GB", 
        "memoryfree_mb": "125401.57", 
...
List example
============
    ./puppetdb.py --server puppetmaster.domain.tld --list
    {
      "node01.domain.tld": {
        "_timestamp": "Fri Mar 13 00:05:47 -0400 2015", 
        "ansible_ssh_host": "node01.domain.tld",
        ...
      },
      ...
      "node99.domain.tld": {
        "_timestamp": "Fri Mar 13 00:05:47 -0400 2015", 
        "ansible_ssh_host": "node99.domain.tld",
        ...
      },
    }
